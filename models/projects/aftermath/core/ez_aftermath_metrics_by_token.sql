...
WITH
    ...
    SELECT
        ...
        SUM(spot_fees_revenue.service_cash_flow) AS service_fee_allocation, 
        SUM(spot_fees_revenue.foundation_cash_flow) AS foundation_fee_allocation,
        SUM(spot_fees_revenue.fees_native) AS spot_fees_native, 
        SUM(spot_fees_revenue.service_cash_flow_native) AS service_fee_allocation_native, 
        SUM(spot_fees_revenue.foundation_cash_flow_native) AS foundation_fee_allocation_native, 
