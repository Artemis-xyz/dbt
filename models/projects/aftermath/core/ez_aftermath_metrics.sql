...
WITH 
    defillama_tvl AS (
        ...
        WHERE defillama_protocol_id = 3636 OR defillama_protocol_id = 3259 OR defillama_protocol_id = 3981
            -- This includes Aftermath Liquid Staking, Aftermath AMM, and Aftermath Aggregator
        GROUP BY 1
    )
