...
WITH
    ...
    , spot_fees_revenue AS (
        SELECT date, pool_address, SUM(fees_usd) AS fees_usd, SUM(service_fee_allocation) AS service_fee_allocation, SUM(foundation_fee_allocation) AS foundation_fee_allocation
