...
with 
    ...
    , issued_supply_and_float as (
        ...
        FROM {{ ref('fact_jito_issued_supply_and_float') }}
    )
    , market_metrics as (
...
SELECT 
    ...
    -- Supply Metrics
    , issued_supply_and_float.max_supply_native as max_supply_native
    , issued_supply_and_float.total_supply_native as total_supply_native
    , issued_supply_and_float.issued_supply_native as issued_supply_native
    , issued_supply_and_float.circulating_supply_native as circulating_supply_native
...
LEFT JOIN issued_supply_and_float using (date)
where true
