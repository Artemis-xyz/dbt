...
with token_incentives as (
    ...
    where contract_address in (lower('0x4483f0b6e2F5486D06958C20f8C39A7aBe87bf8F'), lower('0x188bED1968b795d5c9022F6a0bb5931Ac4c18F00'), lower('0xd6a4F121CA35509aF06A0Be99093d08462f53052') )
