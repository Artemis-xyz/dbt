...
with
    ...
    balances as (
        ...
        from {{ ref("fact_bsc_daily_balances") }}
        where
    ...
    left join
        {{ ref("dim_bsc_sybil_address") }} as sybil on t.from_address = sybil.from_address
