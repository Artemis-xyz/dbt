...
, agg as (
    ...
    SELECT
        ...
        PC_DBT_DB.PROD.HEX_TO_BASE58(SUBSTRING(hex_data,243,64)) as mint, 
        PC_DBT_DB.PROD.BIG_ENDIAN_HEX_TO_DECIMAL(SUBSTRING(hex_data,635,16))/1e6 as price,
        hex_data
    FROM hex_cte
    ...
    SELECT
        ...
        PC_DBT_DB.PROD.BIG_ENDIAN_HEX_TO_DECIMAL(SUBSTRING(hex_data,549,16))/1e6 as price,
        hex_data
    FROM hex_cte
