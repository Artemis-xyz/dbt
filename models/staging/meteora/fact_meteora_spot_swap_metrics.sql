{{
    config(
        ...
        unique_key="date",
        alias="fact_meteora_spot_swap_metrics",
...
WHERE program_id = 'Eo7WjKq67rjJQSZxS6z3YkapzY3eMj6Xy8X5EQVn5UaB' or program_id = 'LBUZKhRxPF3XUpBCjp4YzTKgLccjZhTSDM9YuVaPwxo'
