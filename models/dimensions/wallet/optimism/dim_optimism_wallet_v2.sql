...
from {{ ref("dim_optimism_wallets_fundamental_metrics_v2") }} as fundamental
full join
    {{ ref("dim_optimism_wallets_stablecoin_metrics") }} as stablecoin
    on fundamental.address = stablecoin.address
full join
    {{ ref("dim_optimism_wallets_dex_trade") }} as dex
