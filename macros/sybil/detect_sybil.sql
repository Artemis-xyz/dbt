            ...
            select
                ...
                1 / (
                    1 + exp(
                        - (
                            0.511434  -- Intercept
                            + 0.000579 * scaled_transactions
                            + -0.396464 * scaled_senders
                            + -0.450808 * scaled_time_span_days
                            + 3.404183 * unique_senders_ratio
                            + 0.000006 * stablecoin_balance
                            + 0.000001 * native_token_balance
                        )
                    )
                ) as probability
            from scoring_table
